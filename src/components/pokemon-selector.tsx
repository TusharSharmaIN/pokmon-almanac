        ...
        <Button variant="outline" role="combobox" aria-expanded={open} className="w-full justify-between h-14" disabled={disabled}>
          {selectedPokemon ? (
            <div className="flex items-center gap-2">
              <Image src={selectedPokemon.sprites.other['official-artwork'].front_default || selectedPokemon.sprites.other.dream_world.front_default} alt={selectedPokemon.name} width={40} height={40} />
